...
CHATBOT_RULES = [
    ...
    (["hi", "hello", "hey"],
     ...
     "orders, tickets, and shipping. What do you need?"),

    (["price", "cost", "how much"],
     "Prices are listed on each product page. Tell me a product name and "
...
DEFAULT_REPLY = (
    ...
    "or raise a support ticket and our team will help you directly."
)
...
def chatbot_reply(message: str) -> str:
    ...
    # 1. Try to match a product name from the database
